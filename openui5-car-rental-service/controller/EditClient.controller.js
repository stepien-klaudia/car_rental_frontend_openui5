sap.ui.define([
  ...
  "sap/m/MessageBox"
    ...
    return Controller.extend("openui5-car-rental-service.controller.EditClient", {
      ...
      onInit: function () {
        ...
        fetch("http://localhost:8090/api/clients")
          ...
          .then(data => {
            var filteredClients = data.filter(client => client.blackList === false);
            oModel.setData({clients: filteredClients})
    ...
    onEditPress: function (oEvent){
      const id = oEvent.getSource().getBindingContext().getObject().id; 
      this.getOwnerComponent().getRouter().navTo("ClientEdit", { id });
    },
