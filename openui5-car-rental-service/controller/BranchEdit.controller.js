sap.ui.define([
    ...
    return Controller.extend("openui5-car-rental-service.controller.BranchEdit", {
      ...
      onNavPress: function () {
        this.getOwnerComponent().getRouter().navTo("EditBranch",{},true);
      },
    ...
    onAcceptPress: function (){
        ...
        this.oAcceptAproveMessage = new Dialog({
            ...
            title: "Potwierdzenie",
            content: new Text({text: "Czy na pewno chcesz zaktualizować dane punktu?"}),
            beginButton: new Button({
                ...
                press: function () {
                    ...
                    const branchLocNr = this.byId("BranchEditLocNr").getValue();
                    const branchPostalCode = this.byId("BranchEditPostalCode").getValue();
                    const branchCity = this.byId("BranchEditCity").getValue();
