sap.ui.define([
    ...
    return Controller.extend("openui5-car-rental-service.controller.ClientEdit", {
      ...
      onNavPress: function () {
        this.getOwnerComponent().getRouter().navTo("EditClient",{},true);
      },
    ...
    onAcceptPress: function (){
        ...
        this.oAcceptAproveMessage = new Dialog({
            ...
            title: "Potwierdzenie",
            content: new Text({text: "Czy na pewno chcesz zaktualizować dane klienta?"}),
            beginButton: new Button({
                ...
                press: function () {
                    ...
                    const email = this.byId("ClientEditEmail").getValue();
                    const phone = this.byId("ClientEditTelNr").getValue();
